...
public class SwarmerInputParams {
   ...
   public static final String LOGFILE_FILE_KEY             = "swarmer.logfile.path";
   ...
   public static void setLogfilePathSystemProperty() {
      File   hsqlDbFile  = new File(getHsqldbPath());
      String logfilePath = hsqlDbFile.getParentFile().getAbsolutePath() + "/swarmer.log";
      System.setProperty(LOGFILE_FILE_KEY, logfilePath);
   }
