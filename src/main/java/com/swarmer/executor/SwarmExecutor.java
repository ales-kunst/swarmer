...
// C:\\winapp\\Java\\1.8.0_102\\X64\\JDK\\bin\\java.exe -Dfile.encoding=UTF-8 -Dswarm.bind.address=0.0.0.0 -jar D:\\programming\\java\\test-swarm-app\\target\\demo-swarm.jar
   ...
   public void execute(SwarmerContext swarmerCtx) throws IOException, InterruptedException {
      String line;
      ...
      ProcessBuilder processBuilder = new ProcessBuilder(JAVA_EXE, FILE_ENC_PARAM_01, BINDADDRESS_PARAM_02, JAR_FILE_PARAM_03);
